...
<div class="main-content">
	<section class="section">
		<div class="section-header">
			<h1>Choosen Section</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="{{url('/dashboard')}}">Dashboard</a></div>
              <div class="breadcrumb-item">Choosen Section</div>
            </div>
		</div>
    </section>
...
<!-- Add Choosen-Section Modal -->
<div id="add_section" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-edit">Add Section</i></h5>
            ...
            <div class="modal-body">
                <form action="{{route('choosen-section.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group mb-5">
                                ...
                                <input type="text" class="form-control" id="txtDetail" name="txtDetail"required>
                            </div>
                        </div>
...
<div id="editModal" class="modal custom-modal fade" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{url('choosen-section-update')}}"  method="POST" enctype="multipart/form-data">
					@csrf
					@method('PUT')
					...
					<div class="row">
                        <div class="col-sm-12">
							<div class="input-group mb-4">
								<input type="hidden" value="" id="cmbChoosensectionId" name="cmbChoosensectionId" >
								<label class="col-form-label">Title:&nbsp;</label>
                        ...
                        <div class="col-sm-12">
                            <div class="input-group mb-4">
                                <label class="col-form-label">Detail:&nbsp;</label>
                                <input type="text" class="form-control" id="eDetail" name="txtDetail"required>
                            </div>
                        </div>
			...
			<div class="modal-body">
				...
				<div class="modal-btn delete-action">
					<div class="row float-right">
						<div class="col-6">
							<form action="{{url('delete-choosen-section')}}" method="post" >
								@csrf
								@method("DELETE")
...
<script>
	$(document).ready(function(){
		...
		$(document).on('click','#editsection',function(){
			...
			$.ajax({
				type: "GET",
				url: "/edit-choosen-section/"+eid,
				success:function(response){	
					$('#cmbChoosensectionId').val(eid);	
					$('#eTitle').val(response.section.title);	
					$('#eDetail').val(response.section.detail);	
					$('#eIcon').val(response.section.icon);	
				}
			});
		});
	});
