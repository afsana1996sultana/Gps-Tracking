    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Edit Blogs</div>
            </div>
        </div>
                            ...
                            <form action="{{url('blog-list/'.$blog->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <div>
                                            <img id="preview-img" class="admin-img" src="{{asset('img/'.$blog->blog_img)}}" alt="" height="120px" width="160px">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <div>
                                            <img id="preview-banner-img" class="admin-banner-img" src="{{asset('img/'.$blog->banner_img)}}" alt="" height="120px" width="160px">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" id="txtName" class="form-control"  name="txtName" value="{{$blog->name}}">
                                    </div>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="datetime-local" name="txtPublishedDate" id="txtPublishedDate" class="form-control" value="{{$blog->published_date}}">
                                    </div>
